"""
Algorithms for drift correction in gaze data recorded during reading.
...
Al Madi, N. (2025).
Identifying Eye Movement Patterns for An Adaptive Approach to Correcting Eye Tracking Data
in Reading Tasks. Proceedings of the ACM on Human-Computer Interaction, 9(3), 1-16.
...
fixation_XY - list of original fixation locations
line_Y - list of vertical coordinates of lines of text (AOIs)
