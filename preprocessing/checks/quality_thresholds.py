...
def write_quality_thresholds(output_dir: str | Path) -> None:
    ...
    thresholds = {
        ...
        "avg_validation_error_dva": list(settings.ACCEPTABLE_AVG_VALIDATION_SCORES),
        ...
        "session_total_data_loss_ratio": list(settings.ACCEPTABLE_DATA_LOSS_RATIOS),
        "session_blink_loss_ratio": list(settings.ACCEPTABLE_DATA_LOSS_RATIOS),
        "total_session_duration_s": list(settings.ACCEPTABLE_RECORDING_DURATIONS),
